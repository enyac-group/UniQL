...
from .qwen2_uniql_blocks import Qwen2UniQLDecoderLayer
...
class Qwen2Model(Qwen2PreTrainedModel):
    def __init__(self, config: Qwen2Config, **kwargs):
        ...
        if hasattr(config, "compress_config"):
            ...
            block = partial(Qwen2UniQLDecoderLayer, flex_layer_ratio=layer_ratio_config)
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config, **kwargs):
        super().__init__(config)
        self.model = Qwen2Model(config, **kwargs)
        self.vocab_size = config.vocab_size
