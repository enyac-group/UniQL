...
class W4A16Mamba2Mixer(nn.Module):
    """
    ...
    def from_fp16(cls, originalLayer):
        ...
        qmixer.training = originalLayer.training # not sure why only mamba need this
...
class W4A16Mamba2Block(GradientCheckpointingLayer):
    def __init__(self, config, layer_idx):
        ...
        self.mixer = W4A16Mamba2Mixer(config, layer_idx=layer_idx)
