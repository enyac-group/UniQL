...
class W4A16Mamba2UniQLMixer(nn.Module):
    """
...
class W4A16Mamba2UniQLBlock(GradientCheckpointingLayer):
    def __init__(self, config, layer_idx, flex_layer_ratio=None):
        ...
        self.mixer = W4A16Mamba2UniQLMixer(config, layer_idx=layer_idx, flex_layer_ratio=flex_layer_ratio[layer_idx] if flex_layer_ratio is not None else None)
