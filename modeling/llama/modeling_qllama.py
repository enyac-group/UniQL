...
from .llama_qblocks import W4A16LlamaDecoderLayer
from .llama_uniql_qblocks import W4A16LlamaUniQLDecoderLayer
...
class W4A16LlamaModel(QLlamaPreTrainedModel):
    """
    ...
    def __init__(self, config: LlamaConfig, **kwargs):
        ...
        block = W4A16LlamaDecoderLayer # we could make the bitwidth configurable in the future
        if hasattr(config, "compress_config"):
            layer_ratio_config = kwargs.pop("layer_ratio_config", None)
            block = partial(W4A16LlamaUniQLDecoderLayer, flex_layer_ratio=layer_ratio_config)
...
class W4A16LlamaForCausalLM(QLlamaPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config, **kwargs):
        super().__init__(config)
        self.model = W4A16LlamaModel(config, **kwargs)
        self.vocab_size = config.vocab_size
