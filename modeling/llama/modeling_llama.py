...
from .llama_blocks import LlamaRotaryEmbedding
from .llama_blocks import LlamaDecoderLayer
from .llama_uniql_blocks import LlamaUniQLDecoderLayer
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig, **kwargs):
        ...
        if hasattr(config, "compress_config"):
            ...
            block = partial(LlamaUniQLDecoderLayer, flex_layer_ratio=layer_ratio_config)
