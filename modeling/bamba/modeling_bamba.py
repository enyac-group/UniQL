...
from .bamba_blocks import BambaMixer
...
from .bamba_blocks import BambaDecoderLayer
from .bamba_uniql_blocks import BambaUniQLDecoderLayer
...
class BambaPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, nn.Conv1d)):
            ...
            A_log_values = torch.log(torch.arange(1, module.num_heads + 1, dtype=module.A_log.dtype, device=module.A_log.device))
            module.A_log.data.copy_(A_log_values)
...
class BambaModel(BambaPreTrainedModel):
    ...
    def __init__(self, config: BambaConfig, **kwargs):
        ...
        decoder_layers = []
        block = BambaDecoderLayer
        if hasattr(config, "compress_config"):
            layer_ratio_config = kwargs.pop("layer_ratio_config", None)
            block = partial(BambaUniQLDecoderLayer, flex_layer_ratio=layer_ratio_config)
...
class BambaForCausalLM(BambaPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config, **kwargs):
        super().__init__(config)
        self.model = BambaModel(config, **kwargs)
        self.vocab_size = config.vocab_size
